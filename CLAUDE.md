# CLAUDE.md — CutLog App Context

## Project Overview

This is a personal health & fitness app for Mahit (6ft, 195lbs, cutting to 170lbs by September 30 for a Cabo trip). The project started as a meal plan built in Claude.ai and is now being expanded into a full React Native app with photo-based food logging, calorie tracking, and AI-powered macro estimation.
...
A fully functional React component (not yet React Native) built in Claude.ai. It contains:
...
### Build Roadmap
- **Weekend 1**: Photo logging + AI calorie estimation (Claude Vision API)
...
- This file (`CLAUDE.md`) — full context for continuing the build in Claude Code
